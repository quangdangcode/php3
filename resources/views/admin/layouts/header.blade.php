            ...
            <li class="dropdown messages-menu">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li>
                        <a href="#">
                            <div class="pull-left">
                                <img src="{{ asset('theme/admin/dist/img/user3-128x128.jpg') }}" class="img-circle" alt="user image" />
                            </div>
                            <h4>
                    ...
                    <li>
                        <a href="#">
                            <div class="pull-left">
                                <img src="{{ asset('theme/admin/dist/img/user4-128x128.jpg') }}" class="img-circle" alt="user image" />
                            </div>
                            <h4>
                                Developers
