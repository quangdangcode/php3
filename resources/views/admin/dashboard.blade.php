                        ...
                        <div class="box-body">
                            ...
                            <div class="direct-chat-messages">
                                ...
                                <div class="direct-chat-msg right">
                                    ...
                                    <img class="direct-chat-img" src="{{ asset('theme/admin/dist/img/user3-128x128.jpg') }}"
                                        alt="message user image" />
                                    <!-- /.direct-chat-img -->
                                    <div class="direct-chat-text">
                            ...
                            <div class="direct-chat-contacts">
                                <ul class='contacts-list'>
                                    <li>
                                        <a href='#'>
                                            <img class='contacts-list-img' src="{{ asset('theme/admin/dist/img/user1-128x128.jpg') }}" />
                                    ...
                                    <li>
                                        <a href='#'>
                                            <img class='contacts-list-img' src="{{ asset('theme/admin/dist/img/user7-128x128.jpg') }}" />
                                            <div class='contacts-list-info'>
                                                <span class='contacts-list-name'>
                                                    Sarah Doe
                                    ...
                                    <li>
                                        <a href='#'>
                                            <img class='contacts-list-img' src="{{ asset('theme/admin/dist/img/user3-128x128.jpg') }}" />
                                            <div class='contacts-list-info'>
                                                <span class='contacts-list-name'>
                                                    Nadia Jolie
                                    ...
                                    <li>
                                        <a href='#'>
                                            <img class='contacts-list-img' src="{{ asset('theme/admin/dist/img/user5-128x128.jpg') }}" />
                                            <div class='contacts-list-info'>
                                                <span class='contacts-list-name'>
                                                    Nora S. Vans
                                    ...
                                    <li>
                                        <a href='#'>
                                            <img class='contacts-list-img' src="{{ asset('theme/admin/dist/img/user6-128x128.jpg') }}" />
                                            <div class='contacts-list-info'>
                                                <span class='contacts-list-name'>
                                                    John K.
                                    ...
                                    <li>
                                        <a href='#'>
                                            <img class='contacts-list-img' src="{{ asset('theme/admin/dist/img/user8-128x128.jpg') }}" />
                                            <div class='contacts-list-info'>
                                                <span class='contacts-list-name'>
                                                    Kenneth M.
                    ...
                    <div class="box box-danger">
                        ...
                        <div class="box-body no-padding">
                            <ul class="users-list clearfix">
                                <li>
                                    <img src="{{ asset('theme/admin/dist/img/user1-128x128.jpg') }}" alt="User Image" />
                                    <a class="users-list-name" href="#">Alexander Pierce</a>
                                    <span class="users-list-date">Today</span>
                                </li>
                                <li>
                                    <img src="{{ asset('theme/admin/dist/img/user8-128x128.jpg') }}" alt="User Image" />
                                    <a class="users-list-name" href="#">Norman</a>
                                    <span class="users-list-date">Yesterday</span>
                                </li>
                                <li>
                                    <img src="{{ asset('theme/admin/dist/img/user7-128x128.jpg') }}" alt="User Image" />
                                    <a class="users-list-name" href="#">Jane</a>
                                    <span class="users-list-date">12 Jan</span>
                                </li>
                                <li>
                                    <img src="{{ asset('theme/admin/dist/img/user6-128x128.jpg') }}" alt="User Image" />
                                    <a class="users-list-name" href="#">John</a>
                                    <span class="users-list-date">12 Jan</span>
                                </li>
                                <li>
                                    <img src="{{ asset('theme/admin/dist/img/user2-160x160.jpg') }}" alt="User Image" />
                                    <a class="users-list-name" href="#">Alexander</a>
                                    <span class="users-list-date">13 Jan</span>
                                </li>
                                <li>
                                    <img src="{{ asset('theme/admin/dist/img/user5-128x128.jpg') }}" alt="User Image" />
                                    <a class="users-list-name" href="#">Sarah</a>
                                    <span class="users-list-date">14 Jan</span>
                                </li>
                                <li>
                                    <img src="{{ asset('theme/admin/dist/img/user4-128x128.jpg') }}" alt="User Image" />
                                    <a class="users-list-name" href="#">Nora</a>
                                    <span class="users-list-date">15 Jan</span>
                                </li>
                                <li>
                                    <img src="{{ asset('theme/admin/dist/img/user3-128x128.jpg') }}" alt="User Image" />
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <ul class="products-list product-list-in-box">
                                ...
                                <li class="item">
                                    <div class="product-img">
                                        <img src="{{ asset('theme/admin/dist/img/default-50x50.gif') }}" alt="Product Image" />
                                    </div>
                                    <div class="product-info">
